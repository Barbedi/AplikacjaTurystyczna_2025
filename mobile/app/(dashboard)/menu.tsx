          ...
          <View className="flex-row flex-wrap justify-between mt-5">
            {modules.map((item, index) => (
              <Pressable
                ...
                className="bg-white/20 backdrop-blur-sm  p-6 h-[48%] rounded-2xl  w-[48%] mb-4 "
              >
                <View className="relative flex flex-col items-center justify-center gap-3">
                    <FontAwesome6 name={item.icon} size={32} color="#c084fc" />
