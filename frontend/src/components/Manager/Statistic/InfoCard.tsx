...
const InfoCard = ({ icon, title, value, name, description, unit }: InfoCardProps) => {
  ...
  return (
    <div
      ...
      >
        <h2 className={`text-2xl text-white font-serif flex items-center justify-center  text-center leading-tight transform transition-all duration-500 ${
        ...
        <div className={`text-center transform transition-all duration-500 ${
            ...
            <div className="flex items-center justify-center flex-col">
                ...
                <span className={` font-bold ${name ? "text-sm text-white" : "text-2xl text-purple-300"}`}>
                    {value}
                </span>
                {unit && (
                    <span className={`text-white/80 ${name ? "text-sm" : "text-2xl "}`}>
                    {unit}
                    </span>
                )}
                </div>
