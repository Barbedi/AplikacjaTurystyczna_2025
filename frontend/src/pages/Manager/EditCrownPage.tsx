        ...
        try {
          ...
          if (filename) {
            ...
            if (updatedData.data.data.photo_url) {
              if (isCrownPeak) {
                setImagePreview(filesService.getPeakImgUrl(updatedData.data.data.photo_url));
              } else {
                setUserImagePreview(filesService.getPeakImgUrl(updatedData.data.data.photo_url));
              }
            }
            if (isCrownPeak) {
