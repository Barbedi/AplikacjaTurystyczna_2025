              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-full flex items-center justify-center bg-black/30 opacity-0 group-hover:opacity-100 transition duration-300">
                    <span className="text-white text-sm font-medium">Zmień zdjęcie</span>
                  </div>
                </div>
              ...
              <div className="space-y-5">
                <div className="bg-white/5 rounded-xl p-4">
                  <div className="flex items-center mb-2">
                    <FontAwesomeIcon icon={faUser} className="text-white/70 w-6" />
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 rounded-lg ${
                      editMode ? "bg-white/10 border border-white/30" : "bg-transparent"
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  <div className="flex items-center mb-2">
                    <FontAwesomeIcon icon={faEnvelope} className="text-white/70 w-6" />
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  <div className="flex items-center mb-2">
                    <FontAwesomeIcon icon={faPersonHiking} className="text-white/70 w-6" />
                  ...
                  <select
                    ...
                    value={editMode ? editedUser?.level_of_experience : currentUser.level_of_experience}
                    onChange={handleInputChange}
                    
                  >
                    <option className="bg-gray-800" value="">Wybierz poziom doświadczenia</option>
                    <option className="bg-gray-800" value="beginner">Początkujący</option>
                    <option className="bg-gray-800" value="intermediate">Średniozaawansowany</option>
                    <option className="bg-gray-800" value="advanced">Zaawansowany</option>
                    <option className="bg-gray-800" value="expert">Ekspert</option>
                    <option className="bg-gray-800" value="pro">Profesjonalista</option>
                  </select>
                </div>
                
                <div className="bg-white/5 rounded-xl p-4">
                  <div className="flex items-center mb-2">
                    <FontAwesomeIcon icon={faPersonRunning} className="text-white/70 w-6" />
                  ...
                  <select
                   ...
                   className={`w-full px-3 py-2 rounded-lg ${
                    ...
                    value={editMode ? editedUser?.fitness_level : currentUser.fitness_level}
                    onChange={handleInputChange}
                  >
                    <option className="bg-gray-800" value="">Wybierz poziom wysportowania</option>
                    <option className="bg-gray-800" value="beginner">Brak aktywności</option>
                    <option className="bg-gray-800" value="intermediate">Aktywności 1 - 2 razy w tygodniu</option>
                    <option className="bg-gray-800" value="advanced">Aktywności 3 - 4 razy w tygodniu</option>
                    <option className="bg-gray-800" value="expert">Aktywności 5 - 6 razy w tygodniu</option>
                    <option className="bg-gray-800" value="pro">Aktywności codziennie</option>
                  </select>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  <div className=" rounded-lg  p-3">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-white">Utworzyłeś i zapisałeś trasę <span className="font-semibold">"nazwa Trasy"</span> w ulubionych</p>
