...
const MyProfile = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 mt-4 md:mt-8">
  {!loading && currentUser && (
    <div className="">
      <div className="px-4 md:px-6 relative">
        <div className="flex flex-col items-center gap-4 md:gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-8">
          <div className="flex flex-col items-center gap-4 md:gap-6 lg:flex-row lg:items-center">
            <div
              className="group cursor-pointer relative"
              onClick={handlePhotoClick}
            >
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full shadow-lg ring-4 ring-white/20 overflow-hidden">
                {previewUrl ? (
                  <img
                    src={previewUrl}
                  ...
                  <div className="bg-white/10 w-full h-full flex items-center justify-center">
                    <FontAwesomeIcon
                      icon={faCircleUser}
                      className="text-5xl sm:text-6xl md:text-7xl text-white/80"
                    />
                  </div>
                )}
              </div>
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-2xl sm:text-3xl font-lora font-bold text-white">
                {currentUser.name || "Użytkownik HikeUp"}
              </h1>
              <p className="text-white/70 mt-1 text-sm sm:text-base">{currentUser.email}</p>
            </div>
          </div>
          ...
          <div className="flex gap-2 w-full sm:w-auto justify-center">
            {!editMode ? (
              <button
                ...
                className="bg-white/20 hover:bg-white/30 transition duration-300 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 text-sm sm:text-base"
              >
              ...
              <div className="flex gap-2 flex-wrap justify-center">
                <button
                  ...
                  disabled={isSaving}
                  className="bg-green-600/80 hover:bg-green-600 transition duration-300 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 text-sm sm:text-base"
                >
                ...
                <button
                  ...
                  className="bg-red-600/80 hover:bg-red-600 transition duration-300 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 text-sm sm:text-base"
                >
      ...
      <div className="p-4 md:p-6 flex flex-col gap-6 lg:flex-row">
        <div className="w-full lg:w-1/2">
          <h2 className="text-lg sm:text-xl font-lora text-white mb-4 pb-2 border-b border-white/10">
            Dane profilu
          </h2>
          ...
          <div className="space-y-4 sm:space-y-5">
            <div className="bg-white/5 rounded-xl p-3 sm:p-4">
              <div className="flex items-center mb-2">
                <FontAwesomeIcon
                  icon={faUser}
                  className="text-white/70 w-5 sm:w-6"
                />
                <p className="text-white/70 ml-2 sm:ml-3 text-sm sm:text-base">Imię i nazwisko</p>
              </div>
              <input
                type="text"
                id="name"
                ...
                readOnly={!editMode}
                className={`w-full px-3 py-2 rounded-lg text-sm sm:text-base ${
                  editMode
            ...
            <div className="bg-white/5 rounded-xl p-3 sm:p-4">
              <div className="flex items-center mb-2">
                <FontAwesomeIcon
                  ...
                  className="text-white/70 w-5 sm:w-6"
                />
                <p className="text-white/70 ml-2 sm:ml-3 text-sm sm:text-base">Email</p>
              </div>
              <input
                type="email"
                id="email"
                ...
                readOnly
                className="w-full px-3 py-2 rounded-lg text-white text-sm sm:text-base bg-transparent"
              />
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-3 sm:p-4">
              <div className="flex items-center mb-2">
                <FontAwesomeIcon
                  ...
                  className="text-white/70 w-5 sm:w-6"
                />
                <p className="text-white/70 ml-2 sm:ml-3 text-sm sm:text-base">Poziom doświadczenia</p>
              </div>
              <select
            ...
            <div className="bg-white/5 rounded-xl p-3 sm:p-4">
              <div className="flex items-center mb-2">
                <FontAwesomeIcon
                  ...
                  className="text-white/70 w-5 sm:w-6"
                />
                <p className="text-white/70 ml-2 sm:ml-3 text-sm sm:text-base">Poziom wysportowania</p>
              </div>
              <select
                id="fitness_level"
                disabled={!editMode}
