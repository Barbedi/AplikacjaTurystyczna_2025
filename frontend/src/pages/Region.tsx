...
import { faMountain ,faCircleArrowLeft } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="min-h-screen bg-gradient-to-b from-grad1 to-grad2 pb-24 md:pb-0">
      <div className="container mx-auto py-12 px-4">
        <div className="relative text-center mb-10">
          ...
          <h1 className="text-4xl md:text-5xl text-white font-bold mb-3 font-lora">Szlaki w {region}</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white/10 backdrop-blur-sm text-center py-10 rounded-xl border border-white/20 shadow-lg">
            <p className="text-xl text-white">Nie znaleziono szlaków w regionie {region}.</p>
            <p className="mt-3 text-white/70">Spróbuj wybrać inny region lub sprawdź później.</p>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {trails.map((trail) => (
                ...
                >
                  <div className="p-5">
                    <h2 className="text-2xl font-lora text-white font-semibold mb-3">{trail.name}</h2>
                    ...
                    <p className="text-white/80 mb-4 line-clamp-3">{trail.description}</p>
