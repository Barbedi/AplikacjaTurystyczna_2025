 export function calculateDifficulty(distance:number, elevationGain:number, duration:number, selectedFeatures:string|number[], localFeatures:{ id: number; name: string; weight: number }[]): string {
    let score = 0;
